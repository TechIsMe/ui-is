    ...
    <div className="mt-3">
      ...
      <Container>
        <Row>
          <Col md={4}>
            <Card className="mb-3">
              <img src={Ras} className="card-img-top" alt="Ras" fluid />
              <Card.Body>
          ...
          <Col md={4}>
            <Card className="mb-3">
              <img src={Sprinkle} alt="Ras" fluid />

              <Card.Body>
                <Card.Title className="text-white">
                  Strawberyr-Ice-Cream
                </Card.Title>
                <Card.Text className="text-white">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
          ...
          <Col md={4}>
            <Card className="mb-3">
              <img src={IceCream} className="card-img-top" alt="ras" fluid />
